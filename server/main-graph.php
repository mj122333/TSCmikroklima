...
function createDataChartJS($con, $table, $id_sensor)
{
    ...
    $sql_query = "SELECT (ID_SENZOR, VRIJEDNOST, VRIJEME) FROM " . $table . " WHERE ID_SENZOR=" . $id_sensor . " and vrijeme>(CURDATE()-INTERVAL " . $GLOBALS["SATA"] . " HOUR) order by VRIJEME desc";
